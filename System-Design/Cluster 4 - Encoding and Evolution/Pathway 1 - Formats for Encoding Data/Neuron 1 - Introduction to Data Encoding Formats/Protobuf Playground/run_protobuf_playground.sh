...
IMAGE_NAME="protobuf-playground"
CONTAINER_NAME="protobuf-playground-container"
...
log_info "Starting the Protobuf playground setup..."
...
log_success "Protobuf playground is running at $APP_URL"