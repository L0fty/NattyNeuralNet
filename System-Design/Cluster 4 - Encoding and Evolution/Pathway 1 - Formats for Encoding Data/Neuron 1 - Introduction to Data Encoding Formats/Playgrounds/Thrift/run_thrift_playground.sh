...
IMAGE_NAME="thrift-playground"
CONTAINER_NAME="thrift-playground-container"
...
log_info "Starting the Thrift playground setup..."
...
log_success "Thrift playground is running at $APP_URL"