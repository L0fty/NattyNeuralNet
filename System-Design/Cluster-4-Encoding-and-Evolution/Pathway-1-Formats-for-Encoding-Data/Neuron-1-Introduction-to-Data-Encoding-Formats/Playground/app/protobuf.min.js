  ...
  (r = {
    ...
    6: [
      function (t, i, n) {
        ...
        function g(t, i) {
          return (
            (t[i] | (t[i + 1] << 8) | (t[i + 2] << 16) | (t[i + 3] << 24)) >>> 0
          );
        }
        function j(t, i) {
          return (
      ...
      function (t, i, n) {
        ...
        function o(t, i, n, r) {
          if (i.resolvedType)
            if (i.resolvedType instanceof l) {
              t("switch(d%s){", r);
              for (
                var e = i.resolvedType.values, s = Object.keys(e), o = 0;
                o < s.length;
                ++o
              )
                i.repeated && e[s[o]] === i.typeDefault && t("default:"),
                  t("case%j:", s[o])("case %i:", e[s[o]])("m%s=%j", r, e[s[o]])(
                    "break"
                  );
              t("}");
            } else
        ...
        (n.fromObject = function (t) {
          ...
          (n.toObject = function (t) {
            ...
            for (
              var n = v.codegen(["m", "o"], t.name + "$toObject")("if(!o)")(
                  "o={}"
                )("var d={}"),
                r = [],
                e = [],
        ...
        function s(t, i, n, r, e) {
          ...
          if (
            ...
            for (var s = Object.keys(i), o = 0; o < s.length; ++o)
              "number" == typeof i[s[o]] &&
                (this.valuesById[(this.values[s[o]] = i[s[o]])] = s[o]);
        }
    ...
    16: [
      function (t, i, n) {
        i.exports = o;
        var u = t(24);
        ((o.prototype = Object.create(u.prototype)).constructor = o).className =
          "Field";
        var r,
          e = t(15),
          f = t(36),
        ...
        (o.fromJSON = function (t, i) {
          ...
          Object.defineProperty(o.prototype, "packed", {
            get: function () {
              return (
                null === this.o && (this.o = !1 !== this.getOption("packed")),
                this.o
              );
            },
          }),
    ...
    22: [
      function (t, i, n) {
        i.exports = r;
        var h = t(24);
        ((r.prototype = Object.create(h.prototype)).constructor = r).className =
          "Method";
        var a = t(37);
    ...
    23: [
      function (t, i, n) {
        i.exports = a;
        var r = t(24);
        ((a.prototype = Object.create(r.prototype)).constructor = a).className =
          "Namespace";
        var e,
          s,
          o,
          ...
          (a.prototype.lookup = function (t, i, n) {
            ...
            if (r) {
              ...
              for (var e = 0; e < this.nestedArray.length; ++e)
                if (this.f[e] instanceof a && (r = this.f[e].lookup(t, i, !0)))
                  return r;
    ...
    25: [
      function (t, i, n) {
        i.exports = o;
        var e = t(24);
        ((o.prototype = Object.create(e.prototype)).constructor = o).className =
          "OneOf";
        var r = t(16),
          s = t(37);
        function o(t, i, n, r) {
      ...
      function (t, i, n) {
        ...
        function K(t, i, n) {
          ...
          function A(t, i, n) {
            ...
            if (
              (t &&
                ("string" != typeof t.comment && (t.comment = d()),
                (t.filename = K.filename)),
              v("{", !0))
            ) {
              for (; "}" !== (r = a()); ) i(r);
              v(";", !0);
              ...
              n && n(),
                v(";"),
                t &&
                  ("string" != typeof t.comment || u) &&
                  (t.comment = d(e) || t.comment);
          }
          function x(t, i, n) {
            var r = a();
            if ("group" !== r) {
          ...
          function T(t, i) {
            ...
            (e = e),
              (r = r),
              (s = s),
              (t = t).setParsedOption && t.setParsedOption(e, r, s);
          }
          function S(t, i, n) {
          ...
          return (
            (K.filename = null),
            { package: r, imports: e, weakImports: s, syntax: o, root: i }
          );
        }
      },
      {
    ...
    29: [
      function (t, i, n) {
        i.exports = f;
        var r = t(23);
        ((f.prototype = Object.create(r.prototype)).constructor = f).className =
          "Root";
        var e,
          v,
          d,
        ...
        (f.fromJSON = function (t, i) {
          ...
          (f.prototype.load = function t(i, s, e) {
            ...
            function a(t, i) {
              try {
                if (
                  (p.isString(i) && "{" == (i[0] || "") && (i = JSON.parse(i)),
                  p.isString(i))
                ) {
                  v.filename = t;
                  var n,
                  ...
                  if (r.imports)
                    for (; e < r.imports.length; ++e)
                      (n = h(r.imports[e]) || o.resolvePath(t, r.imports[e])) &&
                        c(n);
                  if (r.weakImports)
            ...
            return o.rpcImpl(
              ...
              function (t, i) {
                ...
                if (!(i instanceof r))
                  try {
                    i =
                      r[o.responseDelimited ? "decodeDelimited" : "decode"](i);
                  } catch (t) {
      ...
      function (t, i, n) {
        ...
        function s(f, h) {
          ...
          function r() {
            ...
            var o = a;
            if (((A.lastIndex = 0), !A.test(g(o++))))
              for (; o < c && !A.test(g(o)); ) ++o;
    ...
    35: [
      function (t, i, n) {
        i.exports = m;
        var o = t(23);
        ((m.prototype = Object.create(o.prototype)).constructor = m).className =
          "Type";
        var u = t(15),
          f = t(25),
          h = t(16),
          ...
          (r.oneOfGetter = function (t) {
            ...
            return function () {
              for (var t = Object.keys(this), i = t.length - 1; -1 < i; --i)
                if (1 === n[t[i]] && this[t[i]] !== Q && null !== this[t[i]])
                  return t[i];
            };
          }),
